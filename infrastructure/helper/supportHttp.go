...
func (s *SupportHttp) GetUser(r *rest.Request) (*model.User, error) {
...
func (s *SupportHttp) GetUserWithConditionalTermsVerification(r *rest.Request, checkTerms bool) (*model.User, error) {
...
func (s *SupportHttp) HasPermissions(u *model.User, permissions []string) bool {
	has := true
	for _, p := range permissions {
