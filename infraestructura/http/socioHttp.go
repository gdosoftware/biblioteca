...
func (s *SocioHttp) AltaSocio(w rest.ResponseWriter, r *rest.Request) {
	defer r.Body.Close()
...
func (s *SocioHttp) ModificacionSocio(w rest.ResponseWriter, r *rest.Request) {
	id := r.PathParam("id")
	defer r.Body.Close()
...
func (s *SocioHttp) BorrarSocio(w rest.ResponseWriter, r *rest.Request) {
	id := r.PathParam("id")
	defer r.Body.Close()
...
func (s *SocioHttp) RecuperarSocio(w rest.ResponseWriter, r *rest.Request) {
	id := r.PathParam("id")
...
func (s *SocioHttp) RecuperarTodosLosSocios(w rest.ResponseWriter, r *rest.Request) {
